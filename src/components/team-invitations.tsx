    ...
    <Card className="flex h-full flex-col">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Link2 className="size-5 text-primary dark:text-violet-300" aria-hidden="true" />
          Invitations
        </CardTitle>
        <CardDescription>
    ...
    <Card>
      ...
      <CardContent className="grid gap-4">
        ...
        {invitations.length ? (
          ...
          <p className="py-5 text-center text-sm text-muted-foreground">No invitations yet.</p>
        )}
      </CardContent>
    </Card>
  );
