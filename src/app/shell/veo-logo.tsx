  ...
  return (
    <span className={cn('inline-flex items-center gap-2', className)}>
      <svg aria-hidden='true' className={cn('size-9 shrink-0', markClassName)} viewBox='0 0 64 64'>
        ...
        <rect className='fill-violet-700 dark:fill-violet-500' width='64' height='64' mask='url(#veo-logo-tiles)' />
        <circle className='fill-red-400 dark:fill-red-300' cx='47' cy='47' r='13' />
      </svg>
      {showWordmark ? <span className='font-heading text-xl font-semibold tracking-tight'>veo</span> : null}
    </span>
  );
}
