...
type TeamOverviewData = Awaited<ReturnType<typeof getTeam>> & {
  sessions: Awaited<ReturnType<typeof listGameSessions>>;
};
...
export function TeamSessions({ sessions, teamId }: { sessions: TeamOverviewData['sessions']; teamId: string }) {
