  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-5 py-5 sm:px-8 lg:px-10">
      ...
      <section className="py-10 sm:py-14">
        ...
        <div className="mb-8">
          <p className="text-sm font-medium text-primary dark:text-violet-300">Team overview</p>
            ...
            <CardContent className="flex flex-col gap-5 py-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-4">
                <span className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-primary/15">
                  <Dices className="size-6 text-primary dark:text-violet-300" aria-hidden="true" />
                </span>
                <div>
                  <h2 className="font-semibold">Ready for a team bingo?</h2>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Shuffle your personal card and start playing.
                  </p>
                </div>
              </div>
              <ButtonLink
                className="h-11 px-5 text-base shadow-lg shadow-primary/25 hover:shadow-primary/35"
                params={{ teamId }}
                size="lg"
