    ...
    <main className="home-shell min-h-screen overflow-hidden">
      ...
      <section className="relative mx-auto grid min-h-[calc(100svh-6rem)] max-w-7xl items-center gap-14 px-5 py-16 sm:px-8 lg:grid-cols-[1.02fr_0.98fr] lg:px-10 lg:py-24">
        <div className="relative z-10 max-w-2xl">
          <Badge
            className="mb-6 rounded-full border-primary/25 bg-primary/7 px-3 py-1 text-primary dark:text-violet-300"
            variant="outline"
          >
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-muted-foreground sm:text-xl">
            Veo verwandelt eure Meetings in ein gemeinsames Bingo-Erlebnis – schnell erstellt,
            einfach geteilt und garantiert nicht langweilig.
          </p>
        ...
        <div className="hero-preview relative mx-auto w-full max-w-xl lg:ml-auto">
          <div className="absolute -inset-6 -z-10 rounded-[3rem] bg-primary/8 blur-2xl" />
          <Card className="relative border-0 bg-card/90 py-0 shadow-2xl shadow-primary/10 ring-1 ring-foreground/8 backdrop-blur">
            <CardHeader className="border-b border-border/70 px-5 py-5 sm:px-7 sm:py-6">
        ...
        <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          ...
          <ol className="mt-14 grid gap-5 md:grid-cols-3">
            {steps.map(({ icon: Icon, number, title, description }) => (
              <li
                className="group rounded-2xl border border-border/70 bg-background/75 p-6 transition-all hover:-translate-y-1 hover:border-primary/25 hover:shadow-xl hover:shadow-primary/5 motion-reduce:transform-none"
                key={number}
              >
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
        <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-card/65 px-6 py-14 text-center shadow-sm sm:px-12 sm:py-16">
          <div className="absolute top-0 left-1/2 h-40 w-80 -translate-x-1/2 -translate-y-2/3 rounded-full bg-primary/10 blur-3xl" />
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-muted-foreground sm:text-lg">
              Erstellt euer erstes Team-Bingo und macht aus bekannten Momenten ein gemeinsames
              Spiel.
            </p>
            <ButtonLink
              className="mt-8 h-12 rounded-xl px-6 text-base shadow-md shadow-primary/10"
              to="/teams"
            >
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 px-5 py-8 sm:flex-row sm:px-8 lg:px-10">
          ...
          <p className="text-center text-sm text-muted-foreground">Bingo für bessere Meetings.</p>
        </div>
      </footer>
    </main>
  );
